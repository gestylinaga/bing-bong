...
function update(): void { 
  ...
  if (ball.x < 0) {
    const fyl: HTMLAudioElement = new Audio('./audio/fyl.mp3');
    fyl.volume = volume;
    fyl.play();
...
function startGame(): void {
  ...
  const liveFromConey: HTMLAudioElement = new Audio('./audio/liveFromConey.mp3');
  liveFromConey.volume = volume;
  liveFromConey.play();
}

// Volume controls
const minus: any = document.getElementById('decrease');
const plus: any = document.getElementById('increase');
const volDisplay: any = document.getElementById('display');
...
minus.addEventListener('click', () => {
  decreaseSound();
  const bingBeep: HTMLAudioElement = new Audio('./audio/bingBeep.mp3');
...
plus.addEventListener('click', () => {
  increaseSound();
  const bongBeep: HTMLAudioElement = new Audio('./audio/bongBeep.mp3');
